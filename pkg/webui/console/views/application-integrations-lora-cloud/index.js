...
const m = defineMessages({
  ...
  loRaCloudInfoText: `With the LoRa Cloud Device & Application Services protocol, you can manage common device functionality at the application layer for LoRaWAN®-enabled devices on a predefined device management LoRaWAN port (199 as default). This protocol consists of a set of messages that are exchanged on a predefined device management LoRaWAN port. The purpose of these messages is three-fold:
